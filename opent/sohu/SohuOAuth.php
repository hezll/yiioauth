...
{ 
     ...
     *  
     * @access public 
     * @param bool $cursor 鍗曢〉鍙兘鍖呭惈100涓叧娉ㄥ垪琛紝涓轰簡鑾峰彇鏇村鍒檆ursor榛樿浠?1寮€濮嬶紝閫氳繃澧炲姞鎴栧噺灏慶ursor鏉ヨ幏鍙栨洿澶氱殑鍏虫敞鍒楄〃 
     ...
     *  
     * @access public 
     * @param bool $cursor 鍗曢〉鍙兘鍖呭惈100涓矇涓濆垪琛紝涓轰簡鑾峰彇鏇村鍒檆ursor榛樿浠?1寮€濮嬶紝閫氳繃澧炲姞鎴栧噺灏慶ursor鏉ヨ幏鍙栨洿澶氱殑绮変笣鍒楄〃 
     ...
     *  
     * @access public 
     * @param mixed $uid_or_name 用户uidㄧ或者用户昵称screen_name   //2011/5/3
     * @return array 
     */ 
    function follow( $uid_or_name ) 
    { 
        return $this->request_with_uid( 'http://api.t.sohu.com/friendships/create/'.$uid_or_name.'.json' ,  $uid_or_name ,  false , false , false , true  ); 
    } 
     ...
     *  
     * @access public 
     * @param mixed $sids 寰崥ID鍙峰垪琛紝鐢ㄩ€楀彿闅斿紑 
     * @return array 
     */ 
    ...
    /** 
     * 杩斿洖鐢ㄦ埛鐨勫彂甯冪殑鏈€杩?0鏉℃敹钘忎俊鎭紝鍜岀敤鎴锋敹钘忛〉闈㈣繑鍥炲唴瀹规槸涓€鑷寸殑銆?
     *  
     * @access public 
