<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('category_path')); ?>:</b>
	<?php echo CHtml::encode($data->category_path); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('redirecturl')); ?>:</b>
	<?php echo CHtml::encode($data->redirecturl); ?>
	<br />
